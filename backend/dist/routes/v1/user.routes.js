...
router
  .route("/update/:id")
  .put(auth_middleware_1.authenticateJwt, user_controller_1.updateUser);
router
  .route("/add/rented-vehicles/:id")
  .put(user_controller_1.addRentedVehicles); // add logic in controller for vehicle duplication
